...
代码：[week03_parallel/atomic_sum/atomic_sum.cu](../week03_parallel/atomic_sum/atomic_sum.cu)。实现两版求和并对比：
...
代码:[week03_parallel/warp_reduce/warp_reduce.cu](../week03_parallel/warp_reduce/warp_reduce.cu)。单 warp 用 5 次 `__shfl_down_sync`(偏移 16/8/4/2/1)把 32 个数归约到 lane0。
...
代码:[week03_parallel/ballot_sync/ballot_sync.cu](../week03_parallel/ballot_sync/ballot_sync.cu)。数一个 32 元素数组里有几个正数。
...
参考：[03_Reduction从错误到优化.md](../cuda_deep_course/course/volume04_parallel_algorithms/03_Reduction从错误到优化.md)
...
代码：[week03_parallel/reduction_sum_full/reduction_sum_full.cu](../week03_parallel/reduction_sum_full/reduction_sum_full.cu)（8 个版本同台对比）。
...
参考：[04_Scan与Histogram.md](../cuda_deep_course/course/volume04_parallel_algorithms/04_Scan与Histogram.md) + GPU Gems 3 Ch.39。
...
### 已完成的 scan 变体（代码：[week03_parallel/scan/scan.cu](../week03_parallel/scan/scan.cu)，全 PASS）
...
### scan 完整阶梯（全部 PASS，[week03_parallel/scan/scan.cu](../week03_parallel/scan/scan.cu)）
...
代码：[week03_parallel/histogram/histogram.cu](../week03_parallel/histogram/histogram.cu)，两版对比。
...
代码：[week03_parallel/stream_overlap/stream_overlap.cu](../week03_parallel/stream_overlap/stream_overlap.cu)。任务：H2D → kernel → D2H。
