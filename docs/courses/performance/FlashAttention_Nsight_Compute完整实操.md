...
> **前置条件：** 本文的全部构建、运行、`ncu` 与 `cuobjdump` 命令都从 `/home/qichengjie/workspace/gpu-kernel-engineering` 执行；实现和原始证据也保存在该仓库中。
...
- [A100 canonical benchmark](https://github.com/starboy520/gpu-kernel-engineering/blob/main/projects/flash_attention/results/generated/a100-fp32.md)
- [Raw CSV](https://github.com/starboy520/gpu-kernel-engineering/blob/main/projects/flash_attention/results/raw/a100-fp32.csv)
