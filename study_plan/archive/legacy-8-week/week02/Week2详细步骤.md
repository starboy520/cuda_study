...
> **总纲**：本周对应 [Programming_Guide学习路径.md](../../../../docs/reference/Programming_Guide学习路径.md) 的 **阶段 2：SIMT 与内存层次**。
...
| [Programming_Model详解.md](../../../../docs/courses/cuda/Programming_Model详解.md) | Memory 相关小节 | 与 Week 1 衔接 |
| [GPU架构图资源.md](../../../../docs/reference/GPU架构图资源.md) | Memory Hierarchy | 可视化 |
...
| [项目清单.md](../../../../docs/reference/项目清单.md) | P03、P04 验收 |
...
- [项目清单.md](../../../../docs/reference/项目清单.md) P03、P04
...
**返回**：[CUDA学习路线图.md](../../../../docs/archive/curricula/CUDA学习路线图_legacy.md) · **总纲**：[Programming_Guide学习路径.md](../../../../docs/reference/Programming_Guide学习路径.md)（阶段 2）· **上一步**：[Week1详细步骤.md](../week01/Week1详细步骤.md)
