...
> 旧版对照见文末 **附录 D**；本地白话版见 [Programming_Model详解.md](../../../../docs/courses/cuda/Programming_Model详解.md)。
...
|-----|------|------------------|-----------|
| 1 | 01–03 | **1. Introduction**（1.1–1.3）+ [Programming_Model详解](../../../../docs/courses/cuda/Programming_Model详解.md) §1–§8 + **2.1** | 环境确认、跑通 `vec_add` |
...
| 资料                                                                                   | 章节（v13.x）                                              | 重点                                      |
| ------------------------------------------------------------------------------------ | ------------------------------------------------------- | --------------------------------------- |
| [Programming_Model详解.md](../../../../docs/courses/cuda/Programming_Model详解.md)                                     | **§1–§8 全文**                                            | 推荐先读，建立编程模型整体图                         |
...
| [GPU卡型专项学习指南.md](../../../../docs/reference/GPU卡型专项学习指南.md) | 第三节 CC 速查                            | sm_75            |
...
| [GPU架构图资源.md](../../../../docs/reference/GPU架构图资源.md) | Memory Hierarchy 归档配图                 | 可视化辅助（新版正文图较少）                |
...
| [项目清单.md](../../../../docs/reference/项目清单.md)     | P02 矩阵乘    | 验收标准         |
...
**本地详解**：[Occupancy详解_从入门到调优.md](../../../../docs/topics/performance/Occupancy详解_从入门到调优.md)（基础：概念+T4数字+实验；进阶：精确计算+调优方法论）
...
- 扫一眼 [项目清单.md](../../../../docs/reference/项目清单.md) P01、P02
